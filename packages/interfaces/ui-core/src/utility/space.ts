...
// Auto margins for flex alignment
...
export const elMn1 = css`
  margin: calc(var(--space-1) * -1);
`;

export const elMn2 = css`
  margin: calc(var(--space-2) * -1);
`;

export const elMn3 = css`
  margin: calc(var(--space-3) * -1);
`;

export const elMn4 = css`
  margin: calc(var(--space-4) * -1);
`;

// Gap utilities (for flex and grid layouts)
export const elGap0 = css`
  gap: var(--space-none);
`;

export const elGapHalf = css`
  gap: var(--space-half);
`;

export const elGap1 = css`
  gap: var(--space-1);
`;

export const elGap2 = css`
  gap: var(--space-2);
`;

export const elGap3 = css`
  gap: var(--space-3);
`;

export const elGap4 = css`
  gap: var(--space-4);
`;

export const elGap6 = css`
  gap: var(--space-6);
`;

export const elGap8 = css`
  gap: var(--space-8);
`;
